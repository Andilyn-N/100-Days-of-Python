# Attempt 2 solves for the "none" showing up when the code is run.
print('''
*******************************************************************************
          |                   |                  |                     |
...
direction_1 = input("You're at a crossroads. Where do you want to go? \n Type \"left\" or \"right\"\n ")
...
if direction_1 == "left" or direction_1 == "Left":
    ...
    if direction_2 == "Wait" or direction_2 == "wait":
        ...
        direction_3 = input("A castle appears out of nowhere. There are three doors; one red, one yellow, and one blue.\n Which one do you chose? \n Type \"red\" or \"yellow\" or \"blue\".\n ")
